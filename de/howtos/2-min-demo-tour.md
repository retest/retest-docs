Die 2-Minuten Tour mit der ReTest Demo
======================================
...
![ReTest Startbildschirm](2-min-demo-tour-1.png)
...
![ReTest Ansicht 'Aktionsfolge aufzeichnen'](2-min-demo-tour-2.png)
...
![SUT Login-Screen](2-min-demo-tour-3.png)
...
![ReTest Ansicht 'Aktionsfolge umwandeln'](2-min-demo-tour-4.png)
...
![ReTest Ansicht 'Suite ausführen'](2-min-demo-tour-5.png)
...
![ReTest Ansicht 'Suite ausführen'](2-min-demo-tour-6.png)
...
![ReTest Ansicht 'Review Report'](2-min-demo-tour-7.png)
...
![ReTest Ansicht 'Review Report' mit ignoriertem Attribut](2-min-demo-tour-8.png)
...
![ReTest Dialog der an einen 'Commit' erinnert.](2-min-demo-tour-9.png)
...
![ReTest Ansicht 'Review Report' ohne Änderungen](2-min-demo-tour-10.png)
...
![ReTest Ansicht 'Ignorierte Elemente' mit den gerade hinzugefügten Elementen](2-min-demo-tour-11.png)
...
oder Ihre Aufzeichnung [interaktiv debuggen](../recapture/actionsfolge-bearbeiten.md).
